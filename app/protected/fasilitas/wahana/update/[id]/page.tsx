...
export default function UpdateRidePage({ params: paramsPromise }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const resolveParams = async () => {
      try {
        ...
        router.push('/protected/fasilitas/wahana');
      }
    };
  ...
  // Then fetch ride data once we have the params
  useEffect(() => {
    if (!params) return;
